...
// Returns the private 'App\Repository\CodeoperationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CodeoperationRepository.php';

return $this->privates['App\\Repository\\CodeoperationRepository'] = new \App\Repository\CodeoperationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
