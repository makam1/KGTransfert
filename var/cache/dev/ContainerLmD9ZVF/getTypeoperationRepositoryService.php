...
// Returns the private 'App\Repository\TypeoperationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TypeoperationRepository.php';

return $this->privates['App\\Repository\\TypeoperationRepository'] = new \App\Repository\TypeoperationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
