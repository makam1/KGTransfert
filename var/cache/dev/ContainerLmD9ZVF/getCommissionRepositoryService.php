...
// Returns the private 'App\Repository\CommissionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CommissionRepository.php';

return $this->privates['App\\Repository\\CommissionRepository'] = new \App\Repository\CommissionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
